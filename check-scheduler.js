...
console.log(
  "https://console.cloud.google.com/functions/list?project=plane-alert-800ff",
);
console.log("");
console.log("Billing URL:");
console.log(
  "https://console.cloud.google.com/billing?project=plane-alert-800ff",
);
console.log("");
...
console.log(
  "If Cloud Scheduler jobs are paused/disabled, re-enable them in the console.",
);
console.log(
  "If billing is the issue, you may need to upgrade or wait for quota reset.",
);
console.log("");
