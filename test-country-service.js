...
console.log(`Registration T7-ABC: ${t7Result.countryCode} (${t7Result.source}, confidence: ${t7Result.confidence})`);
...
console.log(`ICAO hex 500123: ${smHexResult.countryCode} (${smHexResult.source}, confidence: ${smHexResult.confidence})`);
if (smHexResult.metadata?.icaoAllocation) {
  console.log(`  Allocation: ${smHexResult.metadata.icaoAllocation.countryName}`);
...
console.log(`ICAO hex 501123: ${alHexResult.countryCode} (${alHexResult.source}, confidence: ${alHexResult.confidence})`);
if (alHexResult.metadata?.icaoAllocation) {
  console.log(`  Allocation: ${alHexResult.metadata.icaoAllocation.countryName}`);
}
...
console.log(`ICAO hex 4c1234: ${noResult.countryCode} (${noResult.source}, confidence: ${noResult.confidence})`);
...
console.log('Comprehensive result:', JSON.stringify(comprehensiveInfo, null, 2));
