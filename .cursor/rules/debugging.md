...
Updated: 2026-07-18T08:47:31Z · source: `directory/data/deploy-timing.json`
...
| Kiosk quiet 7am–10pm Berlin (MP3 still overnight) | Product: daytime silence on magicmirror | `isKioskQuietHours()` in alert-sound; session chirp skipped in quiet window; `testAlertSound()` bypasses |
