...
- **Agent shell wait:** use `block_until_ms` **150145** (~150s) — poll every 15s; do not pad to 15+ min upfront.
...
Updated: 2026-07-17T08:20:54Z · source: `directory/data/deploy-timing.json`
