...
- **Agent shell wait:** use `block_until_ms` **305938** (~306s) — poll every 15s; do not pad to 15+ min upfront.
...
Updated: 2026-07-17T08:37:07Z · source: `directory/data/deploy-timing.json`
