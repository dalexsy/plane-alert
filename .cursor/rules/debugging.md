...
Updated: 2026-07-21T09:26:57Z · source: `directory/data/deploy-timing.json`
...
| Audio (kiosk/SPA) for boring mil that never got Pushover | In-range chime / SPA MP3+TTS used to ignore boring filter while Pushover skipped trainers/VIP | Same `isBoringMilitaryAircraft` as collectMilitaryNotifications; special still alerts |
