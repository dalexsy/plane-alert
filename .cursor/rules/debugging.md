...
- **Agent shell wait:** use `block_until_ms` **168780** (~169s) — poll every 15s; do not pad to 15+ min upfront.
...
Updated: 2026-07-25T07:57:52Z · source: `directory/data/deploy-timing.json`
