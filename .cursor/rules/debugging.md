...
- **Agent shell wait:** use `block_until_ms` **173522** (~174s) — poll every 15s; do not pad to 15+ min upfront.
...
Updated: 2026-07-16T14:01:15Z · source: `directory/data/deploy-timing.json`
