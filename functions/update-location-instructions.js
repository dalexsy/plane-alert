...
console.log(
  `db.collection('devices').doc('${deviceId}').update({ location: { lat: ${newLocation.lat}, lon: ${newLocation.lon} }, updatedAt: admin.firestore.FieldValue.serverTimestamp() }).then(() => console.log('✅ Updated!')).catch(console.error);`
);
