...
const OPENSKY_CLIENT_ID =
  process.env.OPENSKY_CLIENT_ID || 'canva22@mailinator.net-api-client';
const OPENSKY_CLIENT_SECRET =
  process.env.OPENSKY_CLIENT_SECRET || 'iBmJ6HY5207OqWcxDFvRv6c6K8GD57WI';
