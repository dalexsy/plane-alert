...
exports.isCoordinateLikeLocation = isCoordinateLikeLocation;
exports.humanReadableLocation = humanReadableLocation;
 ...
 */
function isCoordinateLikeLocation(value) {
    if (!value)
        return false;
    const c = value.trim();
    if (!c)
...
function humanReadableLocation(value) {
