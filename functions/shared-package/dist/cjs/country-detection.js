...
exports.ICAO_LOOKUP_CONFIG = void 0;
exports.getCountryFromIcaoHex = getCountryFromIcaoHex;
exports.getCountryFromRegistration = getCountryFromRegistration;
exports.getAircraftCountry = getAircraftCountry;
exports.getRegistrationPrefixesForCountry = getRegistrationPrefixesForCountry;
exports.isKnownCountry = isKnownCountry;
const icao_country_ranges_json_1 = __importDefault(require("../data/icao-country-ranges.json"));
const registration_country_prefix_json_1 = __importDefault(require("../data/registration-country-prefix.json"));
// Precompute decimal values for ICAO ranges
const ICAO_RANGES = icao_country_ranges_json_1.default.map((r) => ({
    ...r,
    startDec: parseInt(r.startHex, 16),
    finishDec: parseInt(r.finishHex, 16),
}));
const REGISTRATION_PREFIXES = registration_country_prefix_json_1.default;
/**
 * ICAO lookup configuration
 */
exports.ICAO_LOOKUP_CONFIG = {
...
function getCountryFromRegistration(registration) {
    ...
    const sortedPrefixes = Object.keys(REGISTRATION_PREFIXES).sort((a, b) => b.length - a.length);
 ...
 */
function getAircraftCountry(registration, icaoHex, apiCountry, isMilitary) {
    // For MILITARY aircraft: ICAO hex is more reliable than registration
    // Military aircraft often use non-standard registrations
    if (isMilitary && icaoHex && exports.ICAO_LOOKUP_CONFIG.enableIcaoLookup) {
    ...
    if (icaoHex && exports.ICAO_LOOKUP_CONFIG.enableIcaoLookup && !isMilitary) {
        const icaoResult = getCountryFromIcaoHex(icaoHex);
        if (icaoResult.countryCode !== 'Unknown') {
            return icaoResult;
        }
 ...
 */
function getRegistrationPrefixesForCountry(countryCode) {
