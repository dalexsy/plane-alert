 ...
 */
export function getCountryFromIcaoHex(icaoHex) {
 ...
 */
export function getCountryFromRegistration(registration) {
 ...
 */
export function getAircraftCountry(registration, icaoHex, apiCountry, isMilitary) {
 ...
 */
export function getRegistrationPrefixesForCountry(countryCode) {
