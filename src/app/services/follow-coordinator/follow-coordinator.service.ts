...
import { AutoFollowService } from '../auto-follow/auto-follow.service';
import { PlaneLogEntry } from '../../components/results-overlay/results-overlay.component';
import { syncFollowModeState } from './follow-mode-sync.util';
...
export class FollowCoordinatorService {
  ...
  constructor(
    ...
    this.planeFollowService.followState$.subscribe((state) => {
      this.currentModes = syncFollowModeState(state.mode, this.currentModes);
    });
  }
  /**
