...
import type { EnvironmentalState } from './environmental-data/environmental-types';
import {
  ...
  locationDistanceKm,
} from './environmental-data/environmental-calculations.util';

export type { AstronomicalData, EnvironmentalState, WeatherData } from './environmental-data/environmental-types';
