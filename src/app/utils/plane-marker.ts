...
import { smoothLerpMarkerToPosition } from './plane-marker-animation.util';
import { buildPlaneMarkerClassString, computePlaneShadowStyle } from './plane-marker-style.util';
import {
  buildTooltipOptions,
  createLeftMarker,
  removeLeftMarker,
  wireMarkerHoverEvents,
} from './plane-marker-tooltip.util';
...
export function createOrUpdatePlaneMarker(
  ...
  const icon = L.divIcon({ className: 'plane-marker-container', html: markerHtml });
